...
const reactCreaterDir = path.dirname(path.dirname(__dirname));
const resolveApp = relativePath => path.resolve(appDirectory, relativePath);

function resolveBundler(relativePath){
...
module.exports = {
  ...
  babelResolveDir: resolveBundler('node_modules'),
  dllManifest:     resolveApp('dll/dll-manifest.json'),
