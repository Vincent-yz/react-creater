  ...
  module: {
    ...
    rules: [
      ...
      // "file" loader for svg
      {
        ...
        loader: 'file',
        query: {
          name: path.posix.join(assetPath, 'static/media/[name].[hash:8].[ext]')
        }
      }
