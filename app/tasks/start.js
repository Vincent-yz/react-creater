...
var fs = require('fs');
var config = require('../config/webpack.config.dev.liuyong');
...
function installDependencies(){
  return exec('npm', ['install'])
    .then(function(res){
      console.log(chalk.green('dependencies installation finished..'));
      return res;
    }, function(err){
      console.log(chalk.red('dependencies installation fail..'));
